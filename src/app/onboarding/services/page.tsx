    ...
    <div className='lg:px-10 px-4 py-5'>
      ...
      <main className=' py-1 w-full flex flex-row gap-2'>
        <section className='w-full lg:max-w-xl'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='mt-10 flex flex-col gap-10'>
            <div className="flex items-start gap-3">
              <Checkbox id="terms-2" defaultChecked />
              <div className="grid gap-2">
                <Label htmlFor="terms-2">Spherex</Label>
            ...
            <div className="flex items-start gap-3">
              <Checkbox id="terms-2" defaultChecked />
              <div className="grid gap-2">
                <Label htmlFor="terms-2">LPR (license plate recognition system)</Label>
                <p className="text-muted-foreground text-sm">
                  By clicking this checkbox, you agree to the terms and conditions.
                </p>
              </div>
            ...
            <div className="flex items-start gap-3">
              <Checkbox id="terms-2" defaultChecked />
              <div className="grid gap-2">
                <Label htmlFor="terms-2">Vehicle violation system</Label>
                <p className="text-muted-foreground text-sm">
                  By clicking this checkbox, you agree to the terms and conditions.
                </p>
              </div>
            ...
            <div className="flex items-start gap-3">
              <Checkbox id="terms-2" defaultChecked />
              <div className="grid gap-2">
                <Label htmlFor="terms-2">Farouq factories</Label>
                <p className="text-muted-foreground text-sm">
                  By clicking this checkbox, you agree to the terms and conditions.
                </p>
              </div>
            ...
            <Button className='mt-5 w-full max-w-40' type='submit' disabled={isSubmitting}>
